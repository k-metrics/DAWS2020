...
ファイル名                       | 内容
---------------------------------|--------------------------------
covid19japan_YYYY-MM-DD.csv      | 上述の加工済個票データ
covid19japan_YYYY-MM-DD.json     | Covid19Japanのオリジナルデータ
covid19japan_YYYY-MM-DD_json.csv | 上記をCSV形式に変換したもの
Google_Forecast_YYYY-MM-DD.csv   | Googleの予測データ
