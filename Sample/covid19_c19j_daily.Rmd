...
新型コロナ関連のニュース
```{r}
news <- "https://gist.githubusercontent.com/k-metrics/76fea197fa32466a2f99ff59f721b98a/raw/b1f478f06486afe8eac2e0ce4c6708571ef57935/covid19_news.csv" %>% 
    readr::read_csv() %>% 
...
x_by_all %>% 
  ...
  ggplot2::ggplot(ggplot2::aes(x = date)) + 
    ...
    ggplot2::geom_vline(ggplot2::aes(xintercept = date), data = emergency,
                        colour = "red", linetype = "dashed", size = 0.15) +
    ggrepel::geom_label_repel(ggplot2::aes(x = date, y = 7000, label = news),
                              colour = "red", size = 2.0, data = emergency) +
    # GoTo開始
