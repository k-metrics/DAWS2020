...
2020/12/10からファイル構成が変更されています。読み込むには`jsonlite`パッケージを利用して以下のコードで読み込んでください。データは[Covid19 Japan](https://covid19japan.com/)のサイトでなく[GitHub](https://github.com/reustle/covid19japan-data)で公開されています。
